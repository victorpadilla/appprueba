...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { duracion: @tarea.duracion, nombre: @tarea.nombre } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { duracion: @tarea.duracion, nombre: @tarea.nombre } }
